			...
			if (!$link) { //testa se a conexão existe
				...
				if($ok){
					...
					if($query){
						...
						if($ok && $ok2)
							echo 'Os dados foram inseridos com sucesso! <a href="../asparadasdeeditar.php">clique aqui para voltar</a>';
					...
					."<br><a href=\"../asparadasdeeditar.php\">clique aqui para tentar novamente</a>";
				}	
