...
<body>
			...
			if ($id_op) {
				...
				echo 'Ponto adicionado! Clique <a href="../homeprof.html">aqui</a> para voltar!';
			}
			else
				echo 'Ocorreu um erro na adição do ponto. Clique <a href="../homeprof.html">aqui</a> para voltar.';
